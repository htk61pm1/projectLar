            ...
            <div class="col-md-10">
                <form action="{{ route('women.update', $woman->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ $woman->name }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="biography" class="form-label">Biography</label>
                        <textarea class="form-control" name="biography" required>{{ $woman->biography }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="field_of_work" class="form-label">Field of Work</label>
                        <input type="text" class="form-control" name="field_of_work" value="{{ $woman->field_of_work }}" required>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <img id="previewImage" class="d-block border rounded" width="356" height="356" src="{{ asset($woman->image) }}" alt="No Image Selected">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="birth_date" class="form-label">Date of Birth</label>
                        <input type="date" class="form-control" name="birth_date" value="{{ $woman->birth_date }}" required>
                    </div>
